...
//NOTE(jimmylee): use TUI's existing animation primitives if/when they want motion. This component
//NOTE(jimmylee): exists so the same data + structure that powers the CLI template renders identically
//NOTE(jimmylee): in the browser using TUI's existing component library — Window, Card, SimpleTable,
