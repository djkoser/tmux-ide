...
function renderUnderline<Id extends string>(
  ...
  return (
    <div
      ...
      onKeyDown={onKeyDown}
      class={
        "flex h-7 shrink-0 items-center gap-2 border-b border-[var(--border)] bg-[var(--bg-strong)] px-3 text-sm uppercase tracking-wide " +
        (props.class ?? "")
      }
    >
...
function renderPill<Id extends string>(
  ...
  return (
    <div
      ...
      onKeyDown={onKeyDown}
      class={
        "inline-flex items-center gap-1 rounded-md border border-[var(--border)] bg-[var(--surface)] p-0.5 text-sm uppercase tracking-wide " +
        (props.class ?? "")
      }
    >
      <For each={props.items}>
